	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				SuperkrassesprojektMod.LOGGER.warn("Failed to load dependency itemstack for procedure SledgehammerRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SuperkrassesprojektMod.LOGGER.warn("Failed to load dependency x for procedure SledgehammerRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SuperkrassesprojektMod.LOGGER.warn("Failed to load dependency y for procedure SledgehammerRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SuperkrassesprojektMod.LOGGER.warn("Failed to load dependency z for procedure SledgehammerRightClickedOnBlock!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SuperkrassesprojektMod.LOGGER.warn("Failed to load dependency world for procedure SledgehammerRightClickedOnBlock!");
			return;
		}
